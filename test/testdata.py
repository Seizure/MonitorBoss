...
# These correlate to the test TOML in conftest.py. Changing these without changing the TOML accordingly
...
f_data_noname_27_alias = info.FeatureData("", 27, ("usbc", "usb-c")) # feature with no name, but aliases
...
cmds_full = frozendict({"cmds_0": (f_data_noname_242_noalias, f_data_noname_84_noalias, feature_data_input_source), "cmds_1": (f_data_noname_242_noalias, f_data_noname_84_noalias, feature_data_color_preset)})
vcps_full = frozendict({"vcp_0": frozendict({f_data_noname_242_noalias: (value_data_12, value_data_34), f_data_noname_84_noalias: (value_data_12, value_data_34), feature_data_input_source: (value_data_hdmi2,)}),
                       "vcp_1": frozendict({f_data_noname_242_noalias: (value_data_12, value_data_34), f_data_noname_84_noalias: (value_data_12, value_data_34), feature_data_color_preset: (value_data_ct5000k,)})})
