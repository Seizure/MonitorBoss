...
_EDID_128_BASE64 = _base64.b64encode(edid_blob).decode()

TEST_PROFILE_TOML_CONTENTS = f"""
[identity]
pnpid = "MBS"
model = "DUMM13"
serial = "DUMMYSERIAL"
...
[capabilities]
raw = "(prot(monitor)type(LCD)model(DUMM13)cmds(04)vcp(10 60(01 0F 11 ) )mccs_ver(2.1))"
